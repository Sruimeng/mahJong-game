function mahjongChiManager() {
    console.log("zoule111"+mahjongChiNumberArray+mahjongPengPaiTemp1);
    ...
    if(nextDirection==1)
    {
        ...
        console.log("mjpCounter:"+mjpCounter);
        ...
        for(var i=0;i<3;i++)
        {
            ...
            mahjongPengPaiArrayp1[mahjongPengPaiTemp1].children[0].material =mjpmesh[mahjongChiNumberArray[i]];
    ...
    }else if(nextDirection==2)
    {
        ...
        for(var i=0;i<3;i++)
        {
            ...
            mahjongPengPaiArrayp2[mahjongPengPaiTemp2].children[0].material =mjpmesh[mahjongChiNumberArray[i]];
    ...
    }else if(nextDirection==3)
    {
        ...
        for(var i=0;i<3;i++) {
            ...
            mahjongPengPaiArrayp3[i].children[0].material = mjpmesh[mahjongChiNumberArray[i]];
